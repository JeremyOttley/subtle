# == Subtle Config {{{
    ...
    grab "W-C-Return",           "urxvtc_mod -e tmux"
    ...
    grab "W-g",                  "magnet"
    grab "W-a",                  "urxvtc_mod -name htop -e htop"
    grab "W-x",                  "i3lock -ubi /home/logan/images/accueil.png"
    grab "W-C-f",                "thunar"
    grab "W-C-w",                "chromium"
    grab "W-S-w",                "midori"
    ...
    grab "XF86HomePage",         "iceweasel /home/logan/.config/infoconf.html"
    grab "XF86Mail",             "icedove"
    grab "XF86Search",           "iceweasel https://www.duckduckgo.com/"
    grab "XF86Calculator",       "speedcrunch"
    grab "XF86Eject",            "toggleeject"
    ...
    tag "web",      "luakit|dwb|iceweasel|midori|chromium|icedove|hotot|pidgin"
    ...
    # Placement
    tag "web_full" do
      match "luakit|dwb|icedove|iceweasel|chromium|midori"
      gravity :ct
    end
...
#      exclude :instance => "scratchpad|htop|cli_browser|newsbeuter|mutt|wcalc|ranger|weechat|ncmpcpp|rtorrent"
    ...
    on :start do
      ...
      Subtlext::Subtle.spawn "xautolock -time 15 -locker 'i3lock -ubi /home/logan/images/accueil.png'" 
